...
public class ChildrenController {
    ...
    public static List<GameObject> GetChildrenWithTag(GameObject father, string tag)
    {
        GameObject[] allChildren = GetChildren(father);
        ...
        {
            if (_child.tag.Equals(tag))
                ChildrenWithTag.Add(_child);
        }

        return ChildrenWithTag;
    }
    public static List<Transform> GetTransformChildrenWithTag(GameObject father, string tag)
    {
        GameObject[] allChildren = GetChildren(father);
        ...
        {
            if (_child.tag.Equals(tag))
                ChildrenWithTag.Add(_child.transform);
        }

        return ChildrenWithTag;
    }
    public static void MakeSonOfFather(GameObject father, GameObject Child)
    {
        Child.transform.SetParent(father.transform, false);
    }

    public static bool HasChild(GameObject father)
    {
        if(GetChild(father) == null) return false;
